...
durch das Ohm'sche Gesetz berechnet werden.
...
\begin{figure}[h]
	...
	% Von Arne Hückelheim - Eigenes Werk (Originaltext: selbst gezeichnet nach Vorlage Datei:Thermoschema.jpg), Gemeinfrei, https://commons.wikimedia.org/w/index.php?curid=18483818
	\label{Abb:thermo}
\end{figure}
...
hieraus die Temperatur an der Messstelle berechnet werden.
